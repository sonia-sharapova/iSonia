...
> HTML, CSS and JavaScript from beginner to solid.

- **Basic html and css for non-web designers**: Basic html and css for non-web designers
...
- **Can We**: A collection of websites focused on browsers usage and features.
  - https://canwe.dev/
- **CSS Bed**: Showcases a multitude of classless CSS frameworks. Just plug one into your <head> and your markup's completely styled. Excellent for small projects and sites
  - http://www.cssbed.com/
- **CSS Reference**: A free visual guide to css
  - https://cssreference.io/
- **Frontend Checklist**: Complete reference for full frontend
  - https://frontendchecklist.io/
- **How 2 code (HTML, JS, CSS)**: How 2 code (HTML, JS, CSS)
  - https://howtocode.club/
- **HTML Cheatsheet**: 
  - https://htmlcheatsheet.com/
- **HTML Docs**: HTML documentation / tutorial
  - https://developer.mozilla.org/en-US/docs/Web/HTML
- **HTML for People**: Good beginner-friendly HTML tutorial
  - https://htmlforpeople.com/
- **HTML Generator**: 
  - https://html-css-js.com/html/generator/
- **HTML Layouts**: Pre-defines layouts
  - https://neothemes.neocities.org/
- **HTML Reference**: A freeguide to html
  - https://htmlreference.io/
- **HTML Reference**: HTML elements reference
  - https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements
- **HTML/CSS**: A Beginner's Guide to HTML and CSS
  - https://webguide.neocities.org/
- **JavaScript**: The Modern JavaScript Tutorial
  - https://javascript.info/
- **KhanAcademy**: JavaScript and the Web
  - https://www.khanacademy.org/computing/computer-programming/programming
- **P5js**: JavaScript for web, online programming
  - https://editor.p5js.org/
- **SitePoint**: Books and courses on various programming topics
  - https://www.sitepoint.com/
- **three.js - examples**: Examples of Animation with three.js
  - https://threejs.org/examples/#webgl_animation_keyframes
- **Three.js Audio**: Tutorial on audio with Three.js
  - https://threejs.org/docs/#api/en/audio/Audio
- **W3 SQL Tutorial**: Tutorial on SQL
  - https://www.w3schools.com/sql/sql_intro.asp
- **W3Schools**: Anything web-based and HTML
  - https://www.w3schools.com/
- **WebFlow**: Community / discourse on WebFlow
  - https://discourse.webflow.com/c/community/35
- **Website Templates**: .elliott.computer/
  - https://html.elliott.computer/
...
## Search & Discovery
> Search engines that are not Google, and ways to stumble on new things.


### Alternative Search Engines
> General-purpose search, private or independent.
...
> Search built for one kind of thing.
