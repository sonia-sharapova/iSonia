...
## Web & Internet Archives
> Snapshots and mirrors of the web and its files.

- **archive.rhizome.org/exhibition/artbase101**: 
  - https://archive.rhizome.org/exhibition/artbase101/
- **Collection of Various Archives**: underconsideration.com/brandnew/collected
...
- **So Much**: A free website link directory where you can find the best human edited links sorted by topic and category
...
## Digital Libraries
> Free books, papers and texts.

- **AO3: Our Own Archive**: Our Own Archive: A fan-created, fan-run, nonprofit, noncommercial archive for transformative fanworks, like fanfiction, fanart, fan videos, and podfic
...
- **Free Tech Books**: Open Source Tech Books
  - https://www.freetechbooks.com/
- **Library Stack**: Another open library
  - https://www.librarystack.org/
- **Memory of the World Library**: A hugeonline library where you can freely download books that have entered the public domain. Over 153,000 titles to choose from.
  - https://library.memoryoftheworld.org/
- **Open library**: openlibrary.org
  - https://openlibrary.org/
- **Project Gutenberg**: A library of over 75,000 free eBooks
  - https://www.gutenberg.org/
- **Standard EBooks**: Free public domain e-books
  - https://standardebooks.org/
- **Ubu Web**: “UbuWeb is a pirate shadow library consisting of hundreds of thousands of freely downloadable avant-garde artifacts”
  - https://www.ubu.com/
- **Universal Digital Archive**: Collection of over 1mill books
  - http://ulib.isri.cmu.edu/

## Curated Collections
> Museums and collections of oddly specific things.


### Games & Retro Tech
> Consoles, calculators, skins and pixel art.
...
- **Go Canucks**: Library of cute lil pixel guys
  - http://gocanucks.free.fr/
- **I/O games**: various I/O games
  - https://iogames.space/
- **KB Archive**: KnowledgeBase, archive of early Microsoft KnowledgeBase Articles
...
### Nature & Science
> Bugs, illusions and answers to odd questions.
...
- **Everything Can Be Scanned**: Everything can be scanned: ecbscanned.com
...
- **Jigsaw Explorer**: Jigsaw puzzlesss
  - https://www.jigsawexplorer.com/
- **Lock Wiki**: All about locks
  - https://lockwiki.com/index.php/Main_Page/
- **Presidential Campaign Commercials**: Presidential Campaign Commercials
  - https://www.livingroomcandidate.org/commercials/1952
- **Rare Historical Photos**: rarehistoricalphotos.com
