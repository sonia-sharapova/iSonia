...
- **CUDA C++ Programming Guide**: C/C++ Programming in CUDA
  - https://docs.nvidia.com/cuda/pdf/CUDA_C_Programming_Guide.pdf
- **GPU Architectures**: Roadmap to understanding GPU architectures
  - https://cvw.cac.cornell.edu/gpu-architecture
- **Intro to CUDA Programming**: CUDA for Python Developers
  - https://www.pyspur.dev/blog/introduction_cuda_programming
- **Low-level programming-university**: Learn about low-level programming
  - https://github.com/gurugio/lowlevelprogramming-university
- **Parallelism**: What Every Computer Scientist Should Know
  - https://temitayoadefemi.github.io/Papers/
- **Programming Parallel Computers**: Hands-on algorithm engineering
  - https://ss64.com/
- **Programming Parallel Computers**: Practical hands-on course on algorithm engineering for modern computers
  - https://ppc.cs.aalto.fi/
- **Sane C++ Libraries**: Some C++ Libraries
  - https://github.com/Pagghiu/SaneCppLibraries
- **The CUDA Handbook**: The CUDA Handbook, A Comprehensive Guide to GPU Programming by Nicholas Wilt
...
- **Code Concepts**: Code Concepts Explained
...
- **Functional CS**: A Self-Learning, Modern Computer Science Curriculum
  - http://functionalcs.github.io/curriculum/
...
- **Snipplr**: Code snippets
  - https://snipplr.com/
- **Structure and Interpretation of Computer Programs**: Structure and Interpretation of Computer Programs by Harold Abelson and Gerald Jay Sussman with Julie Sussman
...
- **Advent of code**: Daily coding problems and projects
  - https://adventofcode.com/
- **Awesome Creative Coding**: Biiiig reference for everything creative code
  - https://github.com/terkelg/awesome-creative-coding
- **Bam Software**: Projects
  - https://www.bamsoftware.com/hacks/
- **Build Your Own <blank>**: Tutorials and resources to build your own software
...
- **Hacking Your Neighbours WiFi**: Guide to hacking the internet
  - https://mango.pdf.zone/hacking-your-neighbours-wifi/
- **JavaScript projects**: Collection of personal projects
  - https://orteil.dashnet.org/
- **Joy of Computing**: Find Coding Projects
  - https://joy.recurse.com/
- **Kaggle**: Open dataset of projects
  - https://www.kaggle.com/datasets
- **OpenProcessing**: Generative are and creative coding
  - https://openprocessing.org/
- **Run Your Own Social**: Tutorial on creating a social media site
  - https://runyourown.social/
- **Science projects**: misc projects from science class
  - https://scienceclass.github.io/category/projects.html
- **Screenshot Garden**: Build your own screenshot garden
...
- **Addonics**: Disk Drives
  - https://www.addonics.com/
- **Arch Linux Wiki**: Arch Linux Wiki
  - https://wiki.archlinux.org/title/Main_page
- **Bash cheat sheet**: Bash Cheat Sheets
  - https://cheat.sh/
...
- **BootDisk**: Free Windows Bootdisks
  - https://www.bootdisk.com/bootdisk.htm
- **GNU OS**: The GNU Operating System
  - https://www.gnu.org/
- **Linux Books**: 20 Best free-download Linux Books (Legal)
  - https://itsfoss.com/learn-linux-for-free/
- **Linux Commands**: Linux command cheat sheet
  - https://www.websentra.com/linux-commands-cheat-sheet/
- **Linux Word Count**: Get Linux word count
  - https://www.vidarholen.net/contents/wordcount/
- **Lubuntu**: Linux distribution. The LXDE interface is fast and efficient
  - http://lubuntu.net/
- **MacOS**: MacOS Guides and Examples
  - https://ss64.com/mac/syntax.html
- **MEGAcmd Setup 1 3 0 0 RC 2 Windows XP SP3 32bit**: MEGA.nz Free Download, Borrow, and Streaming - Internet Archive
  - http://archive.org/details/megacmd-setup-1-3-0-0-rc-2
- **MEGAsync Client 4.3.3.0 Portable Windows XP x86 32bit**: MEGA.nz Free Download, Borrow, and Streaming - Internet Archive
  - http://archive.org/details/megasync-windows-xp.-7z
- **Nixpub Archive**: Public Access Unix Lists
  - https://mw.rat.bz/nixpub/
- **SDF**: Free Shell account and shell access
  - https://sdf.org/
- **.sh Cheats**: Bash scripting cheetsheet
  - https://devhints.io/bash
- **The Linux Kernel Archives**: Linux kernel
  - https://www.kernel.org/
- **Tiny Linux**: A tiny Linux
  - http://www.tinycorelinux.net/welcome.html
- **VOGONS**: PC information and resources
  - https://www.vogons.org/
- **web.mit.edu/~simsong/www/ugh.pdf**: The UNIX-Haters Handbook, Edited by Simson Garfinkel, Daniel Weise, and Steven Strassmann
  - https://web.mit.edu/~simsong/www/ugh.pdf
- **Windows Desktop UX Guide**: Has a chock ton of examples of and descriptions of common things used in Windows programs
  - http://docs.microsoft.com/en-us/windows/win32/uxguide/visual-index
...
- **Collab-vm**: Control collaborative virtual machines
  - http://computernewb.com/collab-vm/
- **Dd-wrt**: Aftermarket router firmware
  - http://www.dd-wrt.com/site/index
- **EFF Archive**: Net Info: Net Resources (Lists, Indexes, etc.)
  - https://w2.eff.org/Net_culture/Net_info/Resources/
- **Home Computer Support Page**: Computer Support, Hardware Specs, Web Page Creation, Reference Sources
  - http://webarchive.me/geocities/SiliconValley/5649/
- **Internet Trash**: Stuff about the internet
  - https://www.internettrash.com/
- **Openwrt**: Alternative router firmware with package customizations
  - https://openwrt.org/
- **Privoxy**: A HTTP proxy with forwarding, useful for non-SOCKS capable programs
  - http://www.privoxy.org/
- **PuTTY**: Free SSH, Telnet client for Windows
  - http://www.chiark.greenend.org.uk/~sgtatham/putty/
- **Retro Computing Internet Resources**: A list of projects which let vintage computers connect to the internet!
  - https://github.com/dotcomboom/retro-computing-internet-resources
...
- **Books for the Budding New Grad**: Computer science and technology books
  - https://mitpress.mit.edu/books-for-the-budding-new-grad-computer-science-and-technology/
- **CCRU**: Cybernetics Culture Research Unit
  - http://www.ccru.net/link.htm
- **CHADNET**: Home of several projects, mainly the wiki (web directory, archive, compendium of knowledge), as well as some games and archives
  - https://chadnet.org/
- **CITI**: Center for Information Technology Integration: Misc. tech information and resources
  - http://www.citi.umich.edu/projects/
- **Compression**: Everything about Compression
...
- **Geek Girls**: Easy to understand computer tips
  - https://geekgirls.com/
- **Hello World Collection**: Over 600 Hello World Programs
  - http://helloworldcollection.de/
- **How to Design Programs**: Program design
  - https://htdp.org/
- **Making software**: A reference manual for people who design and build software
  - https://www.makingsoftware.co/
- **Mobile Phone History**: Mobile Phone Museum
  - http://mobilephonehistory.co.uk
- **Old Computers**: Old Computer Museum
  - https://oldcomputers.net/
- **Papers We Love**: Repository of academic computer science papers
  - https://paperswelove.org/
- **Refactoring Guru**: All about design patterns for software design
  - https://refactoring.guru/design-patterns
- **Simply How**: Simplified Tech Tutorials, How-To Guides and Reviews
  - https://simply-how.com/
- **Text Editors**: Wiki on Text editors
  - https://texteditors.org/cgi-bin/wiki.pl
- **The Architecture of Open Source Applications**: authors of four dozen open source applications explain how their software is structured, and why
  - https://aosabook.org/en/index.html
- **The Cheapskate's Guide to Computers and the Internet**: Cybernetics Culture Research Unit
  - https://cheapskatesguide.org/
- **The Computer Crypt**: Computer Museum
  - https://www.ricomputermuseum.org/collections-gallery
- **The CSS saga**: W3 CSS History
...
- **Marginal Revolution**: AI Talks
  - https://marginalrevolution.com/
- **Michael Nielsen**: Quantum Computing/ML/AI
...
- **UsesThis**: A collection of nerdy interviews asking people from all walks of life what they use to get the job done
  - https://usesthis.com/
- **Virtually Fun**: Musings on old technology and virtualization
  - https://virtuallyfun.com/
- **XanLee**: Math and Programming
  - http://xahlee.info/
...
- **/g**: Technology OG catalog
  - https://catalog.neet.tv/g/
- **Hacker News**: News focusing on computer science and entrepreneurship
  - https://news.ycombinator.com/news
- **Hard Forum**: Hardware forum
  - https://hardforum.com/
- **Hardware Forums**: General hardware forums
  - http://www.hardwareforums.com/
- **Howard Forums**: Mobile Phone Community
  - http://howardforums.com
- **Lainchan**: Technology Board
  - https://lainchan.org/Ω/
- **Legit Reviews**: Reviews of hardware
  - http://www.legitreviews.com/
- **Lobsters**: General tech discussion
  - https://lobste.rs/
- **Miladychan**: AI Development & Content
  - https://boards.miladychan.org/ai/
- **Rip It Apart**: A mix of different random tech stuff including reviews, tests, software development, opinions and more
  - https://ripitapart.wordpress.com/
- **/ru/ - Киберпанк**: russian forum
  - https://legacy.arisuchan.jp/ru/
- **Tech Arena Forums**: Tech forums
  - http://forums.techarena.in/
- **ThinkPad Discussion**: ThinkPad General
